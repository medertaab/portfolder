...
export default function SocialLinks(props) {
  ...
  return (
    <div className="relative border-2 border-textPrimary rounded-2xl max-w-[40rem] m-auto flex flex-wrap gap-5 justify-center p-3 mx-2 mt-0 sm:mx-auto sm:mt-4">
